...
export default function Footer() {
  return (
    <footer className="w-full border-t" style={{ backgroundColor: 'hsl(var(--header-footer-bg))', color: 'hsl(var(--header-footer-text))', borderColor: 'hsl(var(--header-footer-border))' }}>
      <div className="container mx-auto px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="w-16 h-px opacity-30" style={{ backgroundColor: 'hsl(var(--header-footer-text))' }}></div>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-xs tracking-[0.2em] font-semibold mb-6 uppercase opacity-80">Explore</h4>
          ...
          {/* Newsletter & Social */}
          <div>
            <h4 className="text-xs tracking-[0.2em] font-semibold mb-6 uppercase opacity-80">Connect</h4>
            ...
            <form className="flex flex-col gap-3">
              <input
                ...
                className="bg-transparent border px-4 py-2.5 text-sm transition-all duration-300 focus:outline-none focus:shadow-sm"
                style={{ borderColor: 'hsl(var(--header-footer-border))', color: 'hsl(var(--header-footer-text))' }}
              />
              <button type="submit" className="btn-primary bg-black text-white hover:bg-black/90 border-black px-4 py-2.5 text-xs tracking-wider uppercase font-medium">
                Subscribe
              </button>
            </form>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-xs opacity-70" style={{ borderColor: 'hsl(var(--header-footer-border))' }}>
